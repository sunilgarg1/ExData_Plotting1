...
#Line plot for Global_active_power versus time
png(filename = "plot2.png", width = 480, height = 480)
with(electricConsumption_Df, plot(Date_Time,Global_active_power, type="l", xlab = "", ylab = "Global Active Power (kilowatts)"))
dev.off()
